...
function Button(param) {
    let { href, variant = "primary", size = "md", children, className = "", type = "button", onClick } = param;
    const classes = "btn-lift inline-flex items-center justify-center font-semibold rounded-xl transition-all duration-300 ".concat(variants[variant], " ").concat(sizes[size], " ").concat(className);
    if (href) {
...
//# sourceMappingURL=components_623872af._.js.map